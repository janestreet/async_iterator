...
module%test [@name "[of_sequence]"] _ = struct
...
module%test [@name "[of_pipe_reader]"] _ = struct
...
module%test [@name "[of_pipe_writer]"] _ = struct
...
module%test [@name "[of_async_writer]"] _ = struct
  let%expect_test "[closed] stops asynchronously" =
