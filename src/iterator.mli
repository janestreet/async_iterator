...
val filter : (('a, bool, 'a) op[@mode m]) [@@mode m]
val map : (('a, 'b, 'b) op[@mode m]) [@@mode m]
val filter_map : (('a, 'b option, 'b) op[@mode m]) [@@mode m]
...
val contra_filter : (('a, bool, 'a) contra_op[@mode m]) [@@mode m]
val contra_map : (('a, 'b, 'b) contra_op[@mode m]) [@@mode m]
val contra_filter_map : (('a, 'b option, 'b) contra_op[@mode m]) [@@mode m]
val contra_concat_map : (('a, 'b list, 'b) contra_op[@mode m]) [@@mode m]]
